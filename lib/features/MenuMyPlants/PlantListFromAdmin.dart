...
class _MyHomePageState extends State<MyHomePage>
  ...
  TextEditingController editingController = TextEditingController();  TabController controller;  List<String> listItems = ["Johnny Depp","Al Pacino","Robert De Niro","Kevin Spacey","Denzel Washington","Russell Crowe","SBrad Pitt","Sylvester Stallone"];  var items = List<String>();
