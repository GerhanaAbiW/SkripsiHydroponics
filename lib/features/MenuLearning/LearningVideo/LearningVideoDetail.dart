...
class LearningVideoDetail extends StatefulWidget {
  final Video video;

  const LearningVideoDetail({Key key, this.video}) : super(key: key);




  @override
  _LearningVideoDetailState createState() => _LearningVideoDetailState();
}

class _LearningVideoDetailState extends State<LearningVideoDetail> {
