...
class LearningArticleDetail extends StatefulWidget {
  final Article article;

  const LearningArticleDetail({Key key, this.article}) : super(key: key);
  @override
  _LearningArticleDetailState createState() => _LearningArticleDetailState();
}

class _LearningArticleDetailState extends State<LearningArticleDetail> {
