...
class OrderSmallArea extends StatefulWidget {
  _OrderSmallAreaState createState() => _OrderSmallAreaState();
}

class _OrderSmallAreaState extends State<OrderSmallArea> {
  @override
